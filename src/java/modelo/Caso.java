...
public class Caso implements Serializable{
   ...
   private String Observacion;
    ...
    public Caso(int id, String documento, String nombrePaciente, String caso, int cantBloque, String desbloque, int cantLamina, String deslamina, String fecha, String responsable, String ubibloque, String ubilamina, String Observacion) {
        this.id = id;
        this.documento = documento;
        this.nombrePaciente = nombrePaciente;
        this.caso = caso;
       ...
       public Caso(int id, String documento, String nombrePaciente, String caso, int cantBloque, int cantLamina, String fecha, String prestamo, String responsable, String ubibloque, String ubilamina, String Observacion) {
        this.id = id;
        this.documento = documento;
        this.nombrePaciente = nombrePaciente;
        this.caso = caso;
    ...
    public Caso(int id, String documento, String nombrePaciente, String caso, int cantBloque, String desbloque, int cantLamina, String deslamina, String fecha, String prestamo, String responsable, String ubibloque, String ubilamina, String Observacion) {
        this.id = id;
        this.documento = documento;
        this.nombrePaciente = nombrePaciente;
        this.caso = caso;
